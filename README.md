...
| KAFKA_ADMIN_TLS_CERT_PATH | Enables TLS encryption using the certficate at the given path. |
| KAFKA_ADMIN_TLS_KEY_PATH | Enables TLS encryption using the private key at the given path. |
| KAFKA_ADMIN_TLS_VERSION | Enables TLS encryption using the private key at the given path. |
